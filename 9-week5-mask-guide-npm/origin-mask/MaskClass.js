...
class MaskGuide {
    ...
    setMask(el) {
        ...
        console.log(el.getBoundingClientRect().top, document.documentElement.scrollTop);
        ...
        console.log(this.getAbsoluteLeft, this.getAbsoluteLeft);
        ...
        // 3.3 border
        console.log(this.getAbsoluteLeft)
